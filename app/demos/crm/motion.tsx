...
/**
 * Wraps the FlowDesk product site and powers the `[data-reveal]` system with
 ...
 *   element so hover transitions (e.g. `.fd-lift`) behave normally.
 */
...
export function useSmoothScroll() {
  useEffect(() => {
    ...
    const onWheel = (e: WheelEvent) => {
      ...
      // Let horizontal-scroll regions (the pipeline board, fragment cards)
      // consume their own wheel-driven horizontal deltas.
