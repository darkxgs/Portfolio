...
/**
 * Wraps the marketing page and powers the `[data-reveal]` system with a
 ...
 *   element so hover transitions (e.g. `.bs-lift`) behave normally.
 */
 ...
 * Skipped for touch devices, reduced motion, and while the booking modal has
 * locked body scrolling.
 */
